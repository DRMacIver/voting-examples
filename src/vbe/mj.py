"""Majority Judgement is a method of voting proposed by Michel Balinski and
Rida Laraki in "A theory of measuring, electing, and ranking"
...
class MajorityJudgement(object):
    """Objects of type MajorityJudgement support comparison and ordering
    options as per the ordering of the described voting algorithm.

    They expose no other operations.
    ...
    def __init__(self, tally):
        ...
        [1,2,1] means that there is one vote each of grades 0 and 2 and
        2 votes of grade 1, not that there 2 votes of grade 1 and 1 of
        grade 2.
